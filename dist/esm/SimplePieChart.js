...
function ReactECharts2(props) {
    ...
    return (_jsx("div", __assign({ style: !isNullOrEmpty(style) ? style : { width: '100%', height: '100%', background: 'transparent' } }, { children: _jsx("div", { style: __assign({ width: '99%', height: '100%', margin: '0 auto', background: 'transparent' }, style) }) })));
}
export function SimplePieChart(props) {
    ...
    return (_jsx(ReactECharts, { notMerge: true, style: !isNullOrEmpty(style) ? style : { width: '100%', height: '480px' }, option: !isNullOrEmpty(option) ? option : sampleOption }));
}
