...
function ReactECharts2(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ style: !(0, utils_1.isNullOrEmpty)(style) ? style : { width: '100%', height: '100%', background: 'transparent' } }, { children: (0, jsx_runtime_1.jsx)("div", { style: tslib_1.__assign({ width: '99%', height: '100%', margin: '0 auto', background: 'transparent' }, style) }) })));
}
